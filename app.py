...
if os.path.exists(logo_path):
    ...
    st.markdown('<div style="text-align:center; margin:20px 0; color:#FFD700; font-size:20px;">Tricks For Excel</div>', unsafe_allow_html=True)

st.markdown("<h1 style='text-align:center; color:#FFD700;'>📊 Tricks For Excel File Splitter & Dashboard</h1>", unsafe_allow_html=True)
...
with tab1:
    ...
    if uploaded_file:
        ...
        # ✅ زر Clear All files في قسم التقسيم
